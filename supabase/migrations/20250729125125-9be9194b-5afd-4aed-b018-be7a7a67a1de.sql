-- Priority 1: Critical Security Fixes (Fixed)
...
USING (
  ...
  CASE 
    WHEN id = get_usuario_atual() THEN funcao = (SELECT funcao FROM public.usuarios WHERE id = get_usuario_atual())
...
-- Create trigger for admin count validation
...
-- 6. Create function to validate file uploads securely
